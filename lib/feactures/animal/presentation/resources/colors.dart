...
Color colorHead(bool isDarkMode) => isDarkMode ? Colors.red.shade900 : const Color(0xfffa6e68);
...
Color colorLocation(bool isDarkMode) => isDarkMode 
    ? Colors.blue 
    : const Color(0xff8ebbe3);

Color colorLocationFondo(bool isDarkMode) => isDarkMode 
    ? Colors.blue.shade100 
    : const Color(0xffe7f1f9);

Color colorBubleFondo(bool isDarkMode) => isDarkMode 
    ? Colors.grey.shade400 
    : const Color(0xffeaefef);

Color colorBubleIcon(bool isDarkMode) => isDarkMode 
    ? Colors.black 
    : const Color(0xff5c6364);
